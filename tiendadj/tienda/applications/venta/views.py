...
"""
    This view uses the serielizer array fro optimazing the sale register
"""

class RegisterSaleViewv2(CreateAPIView):
    # Authetication verify
    authentication_classes = (TokenAuthentication,)
    permission_classes = [
        IsAuthenticated, #if is authenticated     
    ...
    # using serializer, this line is a mandatory if you use CreateAPIview
    serializer_class = serializers.ProcessSaleSerializerV2
    ...
    def create(self,request,*args, **kwargs):
        """ 
            ...
            In brief, the frontend send infromation in a JSON fromat
        """ 
        _serialized_data = serializers.ProcessSaleSerializerV2(data=request.data)
